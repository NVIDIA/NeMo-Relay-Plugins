...
from scripts.tasks import Context, library_filename, run, write_attributions, write_runtime_manifest
...
def package(ctx: Context):
    ...
    filename = library_filename("nemo_relay_rust_native_plugin_example", ctx.platform)
